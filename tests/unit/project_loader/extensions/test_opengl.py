...
class ExtensionTest(ProjectLoaderBaseTest):
    ...
    def test_extension_strict(self):
        ...
        self.expectThat(opengl_extension.app_snippet, Equals({"plugs": ["opengl"]}))
        self.expectThat(opengl_extension.part_snippet, Equals(dict()))
        self.expectThat(
    ...
    def test_extension_classic(self):
        ...
        self.expectThat(opengl_extension.app_snippet, Equals({}))
        self.expectThat(opengl_extension.part_snippet, Equals(dict()))
        self.expectThat(
            opengl_extension.parts,
            Equals(
